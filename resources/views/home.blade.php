        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="content">
                        <h3>Esir Kota Bogor</h3>
                        <p>
                            merupakan sarana komunikasi proses rujukan yang dapat memberikan informasi rujukan pelayanan
                            kesehatan perorangan
                        </p>
                        <div class="text-center">
                            <a href="#" class="more-btn">Call 119 <i class="bx bx-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div
                    ...
                    <a href="https://www.youtube.com/embed/4qO8raRseJY" class="glightbox play-btn mb-4"></a>
                </div>
